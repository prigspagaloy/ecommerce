...
header.innerHTML = `
    <section class="header">
      <img class="web-logo" src="${window.location.pathname == "./" ? "./Img/ecommercelogo.jpg" : "../Img/ecommercelogo.jpg"}" alt="logo...">
      <div class="delivery-location"></div>
      <div class="search-bar">
          <input type="search" id="search" name="search" placeholder="Search Product">
          <img class="search-img" src="${window.location.pathname == "./" ? "./Img/search.png" : "../Img/search.png"}" alt="search-button">
      </div>
      <div class="language">
      ...
      <div class="cart-hamburger">
        <a href="${window.location.pathname == "./" ? "./pages/cart.html?data=product selected" : "../pages/cart.html?data=product selected"}">
            <div class="add-cart-box">
                ...
                <img class="cart-logo" src="${window.location.pathname == "./" ? "./Img/cart.png" : "../Img/cart.png"}" alt="cart-logo" style="width:2rem; height:1.7rem">
            </div>
        </a>
